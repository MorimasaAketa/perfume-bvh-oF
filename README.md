...
1. Install XCode.
2. Download openFrameworks 0.12.1 or later from [official site](http://openframeworks.cc/download/) .
...
2. Download openFrameworks 0.12.1 or later for Visual Studio 2019 from [official site](http://openframeworks.cc/download/) .
